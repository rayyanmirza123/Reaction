...
{
    // Testing purpose
    $file = DIR_WIN."OpenReact\\Library\\".str_replace('\\', '/', $class).".php";
    if(is_file($file))
    {
        include_once($file);
        return true;
...
{
   // Testing purpose
 $file = DIR_WIN."OpenReact\\Framework\\".str_replace('\\', '/', $class).".php";
    if(is_file($file))
    {
        include_once($file);
        return true;
...
{
    // Testing purpose
    $file = DIR_WIN."OpenReact\\Framework\\Node\\".str_replace('\\', '/', $class).".php";
    if(is_file($file))
    {
        include_once($file);
        return true;
...
{
    // Testing purpose
    $file = DIR_WIN."OpenReact\\Library\\Cache\\".str_replace('\\', '/', $class).".php";
    if(is_file($file))
    {
        include_once($file);
        return true;
