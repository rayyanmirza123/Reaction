...
{
    // Testing purpose
    $file = "/app/OpenReact/Library/".str_replace('\\', '/', $class).".php";
    if(is_file($file))
    {
        include_once($file);
        return true;
...
{
   // Testing purpose
 $file = "/app/OpenReact/Framework/".str_replace('\\', '/', $class).".php";
    if(is_file($file))
    {
        include_once($file);
        return true;
...
{
    // Testing purpose
    $file = "/app/OpenReact/Framework/Node/".str_replace('\\', '/', $class).".php";
    if(is_file($file))
    {
        include_once($file);
        return true;
...
{
    // Testing purpose
    $file = "/app/OpenReact/Library/Cache/".str_replace('\\', '/', $class).".php";
    if(is_file($file))
    {
        include_once($file);
        return true;
